...
```bash
pytest hackathondsa_groupe4/scripts/test_evaluate.py -v
```

You can even just run a specific test by issuing a command like: 
```bash
pytest hackathondsa_groupe4/scripts/test_evaluate.py::test_evaluate -v
```
...
f168e19b8b67        hackathondsa_groupe4_mlflow            "bash -c 'mlflow ui …"   4 days ago          Up 3 days           127.0.0.1:32770->5000/tcp   hackathondsa_groupe4_mlflow_<username>
87f03baf686e        hackathondsa_groupe4_bash     "/bin/bash"              4 days ago          Up 4 days           127.0.0.1:32768->8501/tcp   hackathondsa_groupe4_bash_<username>
d9bd01600486        hackathondsa_groupe4_develop   "bash -c 'cd /mnt &&…"   4 days ago          Up 3 days           127.0.0.1:32769->8888/tcp   hackathondsa_groupe4_develop_<username>
```
