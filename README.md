...
Contribution de l'Equipe 4 au Hackathon de juin 2021 de la Formation DSA
...
```bash
$ make bash
$ python hackathondsa_groupe4/scripts/etl.py configs/examples/config_example.yml
```
...
```bash
python hackathondsa_groupe4/scripts/evaluate.py configs/examples/config_example.yml
```
...
└── hackathondsa_groupe4    <- Project source directory
