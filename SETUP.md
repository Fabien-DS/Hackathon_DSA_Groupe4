...
```bash
git clone git@github.com:manifoldai/hackathondsa_groupe4.git
```
...
The runtime for HackathonDSA_Groupe4 is inside a Docker container. We have a `make` command to launch the appropriate containers. To launch the docker containers and begin working on a CPU, run from the root directory of the repository:
...
c5df791a2731   hackathondsa_groupe4_develop   "bash -c 'cd /mnt &&…"   3 seconds ago   Up 1 second   127.0.0.1:55003->8888/tcp                              hackathondsa_groupe4_develop_<username>
451fa5f876dc   hackathondsa_groupe4_mlflow    "bash -c 'mlflow ser…"   3 seconds ago   Up 1 second   127.0.0.1:55004->5000/tcp                              hackathondsa_groupe4_mlflow_<username>
```
